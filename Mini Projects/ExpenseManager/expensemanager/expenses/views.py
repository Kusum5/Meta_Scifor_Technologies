...
def index(request):
    ...
    #currency = Preference.objects.get(user=request.user).currency
    context = {
        'expenses':expenses,
        'page_obj':page_obj,
    }
...
def export_pdf(request):
    # Create a HttpResponse object with the PDF headers
    ...
    with tempfile.NamedTemporaryFile(delete=False) as output:
        ...
        pdf_content = output.read()  # Read the generated PDF content
